...
class MenuStation extends Component {
                ...
                <Paper >
                    ...
                    <nav className="navbar form-control">
                        ...
                        <div className="navbar-header">
                            ...
                            <Tooltip id="tooltip-charts-view3" title="Активировать станцию для наблюдений">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <Tooltip id="tooltip-charts-view4" title="Удалить из наблюдений">
...
MenuStation.propTypes = {

    classes: PropTypes.object.isRequired
}

export default (withStyles(styles)(MenuStation));